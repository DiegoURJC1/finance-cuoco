function initMusicPlayer() {
    ...
    function updatePlayButtonUI() {
        ...
        // CORRECCIÓN CARDINAL: Buscamos las clases visuales de forma segura dentro de nuestro panel modular
        ...
        if (isPlaying) {
            ...
            visuals.forEach(v => {
                v.classList.remove('is-playing'); // Reseteo limpio de hilos de animación
                void v.offsetWidth; // Truco de renderizado (Reflow) para asegurar el reinicio de CSS
